...
/usr/bin/sudo DEBIAN_FRONTEND=noninteractive  /usr/bin/apt-get install -y mysql-community-client mysql-community-server mysql-community-source mysql-shell mysql-utilities