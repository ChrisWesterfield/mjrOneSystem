 ...
 */
class Php73 extends ProcessAbstract implements ProcessInterface
{
    public const DESCRIPTION = 'PHP Environment';
    public const VERSION = '7.3';
    ...
    public const VERSION_TAG = 'php73';
    public const FPM_IDENTITY = 'admin.info73';
    public const SUBDOMAIN = 'info73.';
